  ...
  return (
    <div className="py-10 mx-auto grid grid-cols-1 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {posts.map((post) => (
          <Link
            className="p-4 flex flex-row items-center justify-between hover:opacity-90 bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-sm rounded-lg overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20 hover:scale-105 border border-gray-500"
            key={post._id}
