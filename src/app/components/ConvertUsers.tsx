...
const ConvertUsers = () => {
  return (
    <div className="bg-gradient-to-b from-[#efefe3] to-[#f2f2f2] min-w-full py-16 md:py-24">
      <div className="container realtive">
        ...
        <div className="flex h-[40rem] relative items-center justify-center antialiased bg-gradient-to-b from-  overflow-hidden">
          <Image
